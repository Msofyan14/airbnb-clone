      ...
      {!isOpen ? null : (
        <div className="justify-center items-center flex overflow-y-auto overflow-x-hidden fixed inset-0 z-50 outline-none focus:outline-none bg-neutral-800/70">
          <div className="relative w-full md:w-4/6 lg:2-3/6 xl:w-2/5 my-6 mx-auto h-full lg:h-auto md:h-auto">
            ...
            >
              <div className="translate h-full lg:h-auto md:h-auto border-0 rounded-lg shadow-lg relative fle flex-col w-full bg-white outline-none focus:outline-none">
                {/* Header */}
